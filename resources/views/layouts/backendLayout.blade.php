    ...
    <aside class="sidebar-nav-wrapper">
      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li class="nav-item {{Request::routeIs('category.show')||Request::routeIs('category.edit')?'active':null}}">
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a href="{{route('products.add')}}"> Add New </a>
              </li>
              <li>
                <a href="blank-page.html" class="active"> All Products </a>
              </li>
            </ul>
          </li>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="https://api.dicebear.com/8.x/initials/svg?seed={{auth()->user()->name}}" alt="avatar"/>
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    <li>
                      ...
                      document.getElementById('signoutform').submit();"
                       href="{{route('logout')}}"> <i class="lni lni-exit"></i> Sign Out </a>
